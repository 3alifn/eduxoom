...
const { authentication_404, authentication_check, forgot_verify_code, singout, forgot_password, reset_password , au_user_header_nav, signout } = require("../controllers/authenticationController")
