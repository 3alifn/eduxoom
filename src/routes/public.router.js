...
const { public_admission_step1, public_admission_step2, public_admission_post, multer_upload_admission, multer_upload_admission_image, multer_upload_admission_any, multer_upload_admission_image_or_pdf } = require("../controllers/admission.controller")
const { public_gallery_video, public_gallery_image, public_gallery_video_list, public_gallery_image_list, public_carousel_get, public_gallery_image_get, admin_gallery_image_data_get, public_gallery_image_data_get, public_gallery_video_get, public_gallery_video_data_get } = require("../controllers/gallery.controller")
const { public_notice_get, public_notice_download, public_notice_view, public_notice_page } = require("../controllers/notice.controller")
const { join, self_verify_code } = require("../controllers/parent.controller")
const { public_rank_class_page, public_rank_page, public_rank_get, public_rank_get_class_base, public_rank_student_get, public_rank_student_get_num, public_rank_student_page, public_rank_student_page_num } = require("../controllers/rank.controller")
const { public_routine_page, public_routine_page_class_base, public_routine_download, public_routine_get } = require("../controllers/routine.controller")
const { public_student_page, public_student_profile, public_student_list, self_join_student, self_student_verify_code, self_student_send_mail, public_student_get, public_student_profile_get, public_student_paginationt, public_student_pagination } = require("../controllers/student.controller")
const { public_teacher_list, public_teacher_profile_get } = require("../controllers/teacher.controller")
const { app, sqlmap } = require("../configs/server")
const { public_team_saanvi_sent_message } = require("../controllers/team.controller")
const school_app = require("../controllers/school.controller")
const { pu_class_secton_rm } = require("../controllers/classSection.controller")
const { public_library_get } = require("../controllers/library.controller")
const { pu_school_get, pu_headofschool_get, au_user_nav, au_user_profile_header_nav } = require("../controllers/home.controller")
const { pu_headofschool_render } = require("../controllers/headofschool.controller")
const headofschool_app = require("../controllers/headofschool.controller")
const { public_staff_page, public_staff_profile_get } = require("../controllers/staff.controller")
const { admin_achievement_page, public_achievement_view, public_eventnews_page, public_eventnews_view, admin_facilities_view, public_facilities_view, public_achievement_page, public_facilities_page } = require("../controllers/repository.controller")
const {pu_attn_checkout_webapi_present, pu_attn_checkout_logs, pu_attn_checkout_webapi_absent_student, pu_attn_checkout_webapi_absent_staff, pu_attn_checkout_webapi_absent_teacher } = require("../controllers/attnApi.controller")
