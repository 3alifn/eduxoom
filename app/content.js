        ...
        if(info){
           ...
           for (let i = 0; i < info.length; i++) {
            ...
            <a href="/pu/gallery/image/list?data=${info[i].data_id}" class=" link-primary">
              <img height='200px' width='100%' class='bg-demo-img-color hover-img' src="/image/content/resized/${info[i].item_name}" alt="404">
        ...
        if(info){
          ...
          let imgsource=''
           ...
           for (let i = 0; i < info.length; i++) {
            ...
            <img style='display:block' class="bg-demo-img-color img-btn h-100 w-100"  src="/image/content/resized/${info[i].item_name}">
