...
exports.admin_library_post = (req, res)=>{
    ...
    let sql= `INSERT INTO library (book_name, book_author, book_copy, class_name, section_name, book_photos, description) VALUES ("${bookName}", "${authorName}", "${bookCopy}","${className}", "${sectionName}", "${filenameBook}", "${description}")`
