const noview= {
    ...
    if(filesize <= max_kb_size){
      ...
      if( file_type=='image' && filetype=='image/jpeg' || filetype=='image/jpg' || filetype=='image/png' || filetype=='image/gif'){
        if(multiple==true){
          $('.'+append_class).append(`<img class="rounded" src="${tmppath}" width="200px" height="150px" alt="">`)
        } else{
          $('.'+append_class).html(`<img class="rounded" src="${tmppath}" width="200px" height="150px" alt="">`)
