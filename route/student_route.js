...
// self router.........
const multerUploaderStudent = globalMulterUploader({name: ['single', 'image'], path: "./public/image/student/", size: 500 * 1024, filter: 'image/' });
...
// application router.........
const multerUploaderApplication = globalMulterUploader({name: ['single', 'attachment'], path: "./public/docs/application/", size: 500 * 1024, filter: ["image/png", "image/jpeg", "application/pdf"] });
